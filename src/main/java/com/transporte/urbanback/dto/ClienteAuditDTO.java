...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "DTO para el historial de auditoría de un cliente")
public class ClienteAuditDTO {

    @Schema(description = "ID único del registro de auditoría", example = "1")
    private Long id;

    @Schema(description = "ID del cliente al que se refiere el registro de auditoría", example = "101")
